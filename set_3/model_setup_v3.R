...
save(money_fold, money_recipe,
     file = "set_3/model_info_v3/money_setup_v3.rda")
...
# random forest
load(file = "set_3/model_info_v3/rf_tune_v3.rda")
...
# write_csv(final_rf_results, "set_3/kaggle_submission/rf_output_v3.csv")
