...
# NOTE: This is a duplicate copy of the original "model_setup" script from the "set_1" folder. 
# This setup and tuning script was used as a submission entry into the Kaggle regression competition.
...
save(money_fold, money_recipe,
     file = "final_models/model_info/money_setup.rda")
...
# # included here to demonstrate understanding
# knn_tune %>% 
#   autoplot(metric = "rmse")
# 
# bt_tune %>% 
